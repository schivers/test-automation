"""
interface_pkts_ins.py
Verify if packets have been received on network interfaces in the testbed.
"""
...
class interface_pkts_in(aetest.Testcase):
    """interface_pkts_in
    ...
    counter_input_keys = ("pkts_ins", "in_broadcast_pkts", "in_multicast_pkts")
                ...
                for interface_name, interface in interfaces.items():
                    with device_step.start(
                        ...
                        if "counters" in interface.keys():
                            ...
                            for counter in self.counter_input_keys:
